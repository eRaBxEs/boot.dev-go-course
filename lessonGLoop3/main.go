...
func test(costMultiplier float64, maxCostInPennies int) {
	fmt.Println("Multiplier:", costMultiplier)
	fmt.Println("Max cost:", maxCostInPennies)
	numMessages := getMaxMessagesToSend(costMultiplier, maxCostInPennies)
	fmt.Printf("Max messages you can send: %d\n", numMessages)
	fmt.Println("==============================================================================")
